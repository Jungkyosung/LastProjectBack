...
//			.and().addFilter(getAuthenticationFilter());
		...
		http.authorizeRequests()
			.antMatchers("/login", "/ws/**", "/api/login/google", "/api/idduplicatecheck", "/api/nicknameduplicatecheck", "/api/regist", "/error", "/api/something/mainpage", "/api/getImage/**", "/chatroombyuser", "/api/koreaprice", "/api/exchangeList", "/api/course").permitAll() //로그인 없이 허용할 주소 설정.
